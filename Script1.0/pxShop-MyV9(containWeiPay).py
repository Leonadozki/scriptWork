...
driver.find_element_by_id("keywords").send_keys("931462") #My v9
...
if tokenofkm=='0NVJLX8F':
    print u"successful to setting right Muyingv9 customer!"                     
else:
    print u"wrong Muyingv9 customer!"
driver.find_element_by_id("submit").click()
driver.implicitly_wait(1)
...
print "successful !"
driver.get(first_url);
print "now back and login Muyingv9 account"
# driver.find_element_by_id("username").send_keys("102999") #websale
driver.find_element_by_id("username").send_keys("103020") #My v9
