...
driver.find_element_by_id("keywords").send_keys("644448") #Zm v10
...
if tokenofkm=='JX28ND60':
    print u"successful to setting right ZhuanMai customer!"                     
else:
    print u"wrong ZhuanMai customer!"
driver.find_element_by_id("submit").click()
driver.implicitly_wait(1)
...
print "successful !"
driver.get(first_url);
print "now back and login ZhuanMai account"
# driver.find_element_by_id("username").send_keys("102999") #websale
driver.find_element_by_id("username").send_keys("103016") #Zy v9
