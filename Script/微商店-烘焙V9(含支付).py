...
driver.find_element_by_id("keywords").send_keys("737597") #Hb v9
...
if tokenofkm=='P08FBTB4':
    print u"successful to setting right Hongbeiv9 customer!"                     
else:
    print u"wrong Hongbeiv9 customer!"
driver.find_element_by_id("submit").click()
driver.implicitly_wait(1)
...
print "successful !"
driver.get(first_url);
print "now back and login Hongbeiv9 account"
# driver.find_element_by_id("username").send_keys("102999") #websale
driver.find_element_by_id("username").send_keys("103017") #Hb v9
