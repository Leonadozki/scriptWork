...
first_url='http://weixin.kemai.com.cn/'
...
driver.find_element_by_id("keywords").send_keys("425921") #Zy v9
...
driver.find_element_by_link_text(u"接口权限").click()
driver.implicitly_wait(3)
driver.find_element_by_id("authBt").click()
driver.find_element_by_name("popInput").clear()
driver.find_element_by_name("popInput").send_keys("weixin.kemai.com.cn")
driver.find_element_by_class_name("js_btn").click()
driver.implicitly_wait(3)
driver.find_element_by_link_text(u"基本配置").click()
...
driver.find_element_by_id("username").send_keys("101688") #Zy v9
# driver.find_element_by_id("username").send_keys("103001")  #Cy v8
driver.find_element_by_id("password").send_keys("123456")
driver.find_element_by_class_name("loginBut").click()
driver.implicitly_wait(3)
driver.find_element_by_link_text(u"菜单配置").click()
print "refresh menu"
driver.find_element_by_id("btnUpdateMenu").click()
driver.find_element_by_link_text(u"确定").click()
driver.find_element_by_link_text(u"确定").click()
print "done."
