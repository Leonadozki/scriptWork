...
driver.find_element_by_id("keywords").send_keys("43375") #Ys v9
...
if tokenofkm=='RJJJ820L':
    print u"successful to setting right Yushangv9 customer!"                     
else:
    print u"wrong Yushangv9 customer!"
driver.find_element_by_id("submit").click()
driver.implicitly_wait(1)
...
print "successful !"
driver.get(first_url);
print "now back and login Yushangv9 account"
# driver.find_element_by_id("username").send_keys("102999") #websale
driver.find_element_by_id("username").send_keys("103007") #Ys v9
