...
# driver.find_element_by_id("keywords").send_keys("256803") #Zy v9
driver.find_element_by_id("keywords").send_keys("148919") #Cy v8
...
if tokenofkm=='8L6J06P0':
    print u"successful to setting right CanYinV8 customer!"                     
else:
    print u"wrong CanYinV8 customer!"
driver.find_element_by_id("submit").click()
driver.implicitly_wait(1)
...
print "successful !"
driver.get(first_url);
print "now back and login CanYinV8 account"
# driver.find_element_by_id("username").send_keys("102999") #websale
# driver.find_element_by_id("username").send_keys("103006") #Zy v9
driver.find_element_by_id("username").send_keys("103005")  #Cy v8
