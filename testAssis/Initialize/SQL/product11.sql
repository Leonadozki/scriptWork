   ...
   --获取小票号+
	...
	begin
	   ...
	   insert into pos_t_saleflow ( flow_id, flow_no, branch_no, item_no, item_clsno, sup_no, source_price, sale_price, 
                                   ...
                                   batch_no, cash_no, vip_no, pool_flag, deduct_jf, jfhg_flag, item_subno, old_no,color_no,size_no,other2 ) 
	   values (@li_i1,@flow_no_pos,@branch_no,@item_no,'', '', @sale_price,@sale_price,
              ...
              @batch_no,@cash_no,@vip_no,@pool_flag,0,'',@item_subno,'1','00','00','线上消费')
	   if @@error !=0
	   begin
