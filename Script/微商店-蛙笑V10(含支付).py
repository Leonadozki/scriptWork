...
if tokenofkm=='88282240':
    print u"successful to setting right Websale customer!"                     
else:
    print u"wrong websale customer!"
driver.find_element_by_id("submit").click()
driver.implicitly_wait(1)
...
print "successful !"
driver.get(first_url);
print "now back and login Websale account"
